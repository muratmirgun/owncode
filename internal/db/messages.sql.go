...
RETURNING id, session_id, role, parts, model, created_at, updated_at, finished_at, reasoning_effort
`
...
SELECT id, session_id, role, parts, model, created_at, updated_at, finished_at, reasoning_effort
FROM messages
WHERE id = ? LIMIT 1
`
