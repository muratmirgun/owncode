...
func getColor(adaptiveColor theme.AdaptiveColor) string {
	if theme.IsDark() {
...
func applyHighlighting(content string, segments []Segment, segmentType LineType, highlightBg theme.AdaptiveColor) string {
